  ...
  <section class="py-20 bg-white">
    <div class="container mx-auto px-4">
      ...
      <div v-if="data.layout === 'grid'" class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        >
          <div v-if="data.showIcons" class="w-12 h-12 bg-gradient-to-br from-primary to-accent rounded-lg flex items-center justify-center mb-4">
          ...
          <p v-if="data.showDescription" class="text-gray-600 leading-relaxed">
            {{ service.description }}
          </p>
        </div>
      </div>
      ...
      <div v-else-if="data.layout === 'list'" class="max-w-4xl mx-auto space-y-6">
        ...
        >
          <div v-if="data.showIcons" class="w-16 h-16 bg-gradient-to-br from-primary to-accent rounded-lg flex items-center justify-center flex-shrink-0">
          ...
          <div class="flex-1">
            ...
            <p v-if="data.showDescription" class="text-gray-600">
              {{ service.description }}
            </p>
          </div>
        </div>
